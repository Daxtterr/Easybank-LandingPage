        ...
        <div className="flex md:space-x-2 flex-col text-center md:text-left md:flex-row space-y-12 md:space-y-0 justify-between">
          <div className="flex flex-col space-y-1 bg-white pb-6 md:pb-2">
            ...
            <span className="text-slate-400 text-xs px-2">
              The world is getting smaller and <br className="hidden md:block" />
              we're becoming more mobile. So <br className="hidden md:block" />
              why should you be forced to only <br className="hidden md:block" />
          ...
          <div className="flex flex-col space-y-1 bg-white pb-6 md:pb-2">
            ...
            <span className="text-slate-400 text-xs px-2">
              ...
              spending and set realistic limits <br className="hidden md:block" />
          ...
          <div className="flex flex-col space-y-1 bg-white pb-6 md:pb-2">
            ...
            <span className="text-slate-400 text-xs px-2">
              we want you to enjoy your travels. <br className="hidden md:block" />
          ...
          <div className="flex flex-col space-y-1 bg-white pb-6 md:pb-2">
            ...
            <span className="text-slate-400 text-xs px-2">
              ...
              whole team, we're excited to launch <br className="hidden md:block" />
              our closed beta. It's easy to request <br className="hidden md:block" />
