const Footer = () => {
  return (
    <div className=" text-center md:text-left bg-indigo-900 lg:-translate-y-[20rem] lg:-mb-[20rem]">
      <div className="w-10/12 mx-auto flex flex-col  md:flex-row justify-between py-8">
        <div className="mx-auto md:mx-0 flex flex-col space-y-6 md:space-y-12 mb-6 md:mb-0">
          <div className="">
        ...
        <div className="flex flex-col space-y-2 text-white">
          ...
          <span className="hover:text-green-500 cursor-pointer">Blog</span>
        </div>
        <div className="flex flex-col space-y-2 text-white mb-6 md:mb-0">
          <span className="hover:text-green-500 cursor-pointer">Careers</span>
          <span className="hover:text-green-500 cursor-pointer">Support</span>
          <span className="hover:text-green-500 cursor-pointer">
            Privacy Policy
          </span>
        </div>
        <div className="flex flex-col space-y-6">
          <button className="w-9/12 mx-auto md:mx-0 bg-gradient-to-r from-green-500 to-blue-500 text-white px-6 py-3 rounded-full text-sm hover:opacity-70">
            Request Invite
          </button>
